...
*The listing sheet, as PDF, can be found [[https://github.com/alhassy/CheatSheet/blob/master/CatsCheatSheet.pdf][here]]*, while below is a quick-n-dirty html rendition.
