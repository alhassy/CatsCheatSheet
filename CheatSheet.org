...
* Monoidal Categories
  ...
  A /monoidal category/ /(𝒞, ⊗, I, α, λ, ρ)/ consists of a category 𝒞 with bifunctor /_⊗_ : 𝒞² → 𝒞/ and object /I : Obj 𝒞/
  and three natural isomorphisms: The ‘associator’ /α_{A, B, C} : A ⊗ (B ⊗ C) ≅ (A ⊗ B) ⊗ C/ and the ‘unitors’
  /λ_A : I ⊗ A ≅ A/ and /ρ_A : A ⊗ I ≅ A/ such that:
  ...
  1. Unit elimination paths are the same even if unnecssarily associtivity is performed; i.e.,
  ...
  + The counit $ev_Z = ⌈\Id_{Y ➩ z}⌉ : (Y ➩ Z) ⊗ Y → Z$ is called the /evaluation morphism./
