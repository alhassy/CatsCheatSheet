...
/tails = rev ﹔ inits ﹔ Seq rev/  can be proven --just type checking!
...
** §3 FIX
 0. §3.1, page 65: The code block is terminated by a superfluous semicolon, ~;~, as is the case for after (3.8) and
     in exercise 3.5.
