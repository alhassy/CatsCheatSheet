...
* Gluing functions which do not compose -- products
...
* COMMENT Gluing functions which do not compose -- coproducts
...
* COMMENT §2.10 Mixing products and coproducts
...
* COMMENT §2.15 Gluing functions which do not compose --exponentials
...
* COMMENT §2.17 Initial and terminal datatypes
